...
public class PermissionHelper {
     ...
     */
    private static void requestMultiPermission(Context context, Action grantedAction,
     ...
     */
    private static void requestSinglePermission(Context context, Action grantedAction,
